...
internal class CreateTemplateActivity : AppCompatActivity() {
    ...
    private val barcodeBoundingBoxesMap = mutableMapOf<BarcodeResult, View>()
            ...
            object : CameraXBarcodeCallbackAdapter() {
                ...
                override fun aggregatedBarcodeResults(barcodes: List<BarcodeResult>) {
                    ...
                    barcodes.forEach { barcodeResult ->
                        ...
                        if (barcodeBoundingBoxesMap.containsKey(barcodeResult).not()) {
                            barcodeBoundingBoxesMap[barcodeResult] = View(this@CreateTemplateActivity)
                                .apply {
                                    tag = barcodeResult
                                    setOnClickListener {
                        ...
                        val boundingBoxView = barcodeBoundingBoxesMap[barcodeResult] ?: return@forEach
                    ...
                    val keysToBeRemoved = barcodeBoundingBoxesMap.keys.filter { barcodes.contains(it).not() }
