...
internal class GPOCourier : Courier( listOf("") ) {

    val pattern by lazy {
        VisionRegex("[Pp]akistan [Pp]ost", RegexType.Default)
    }

    val patternTracking1 by lazy {
        VisionRegex("(UMS|RGL)[0-9]{8}", RegexType.TrackingNo)
    }
